...
<div style="display: flex; gap: 2rem; align-items: flex-start; flex-wrap: wrap; margin-bottom: 1.5rem;">
  ...
  <div style="flex: 1; min-width: 260px;">
    <p style="margin: 0;"><b>Technical lead</b> for research, program evaluation, and strategic business operations in the non-profit sector. Builds principled and beautiful data tools across the full stack—from the visualizations, reports, and dashboards people interact with to the models, pipelines, and cloud architecture that scale them. Turns big and messy data into insights for both technical and non-technical audiences. Grounded in reproducibility and open science.</p>
