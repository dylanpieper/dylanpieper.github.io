...
<div style="display: flex; gap: 2rem; align-items: flex-start; flex-wrap: wrap; margin-bottom: 1.5rem;">
  ...
  <div style="flex: 1; min-width: 260px;">
    <p style="margin: 0;"><b>Data scientist and software developer</b> in research, program evaluation, and business operations. Designs and builds principled and beautiful data tools across the full stack—from the visualizations, reports, and applications people interact with to the models, pipelines, and systems that scale them. Turns big and messy data into insights for both technical and non-technical audiences. Grounded in reproducibility and open science.</p>
...
Quantitative thesis, statistical computing (R), research assistant, teaching assistant
