---
title: "Resume"
subtitle: "Data and Analytics Engineer • Data Scientist • Social Scientist"
---
...
<div style="display: flex; gap: 2rem; align-items: flex-start; flex-wrap: wrap; margin-bottom: 1.5rem;">
  ...
  <div style="flex: 1; min-width: 260px;">
    <p style="margin: 0;"><b>Technical lead</b> and <b>support professional</b> for research, program evaluation, and strategic business operations in the non-profit sector. Builds beautiful, easy-to-use data tools across the full stack—from visualizations, reports, and dashboards to the models, pipelines, and cloud architecture that scale them. Turns big, messy datasets into insights for technical and non-technical audiences alike. Grounded in reproducibility and open science.</p>
