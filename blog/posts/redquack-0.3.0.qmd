---
title: "🎉 Releasing redquack 0.3.0"
author: "Dylan Pieper"
date: "2025-11-30"
format: 
  html:
...
This release of redquack is bittersweet for me. I started a new job, which means I can no longer access the large REDCap project I used to create the package. In the meantime, the development of redquack will slow down as I try to grow a community of users.

I'm excited to share what's new in redquack 0.3.0. This release includes a complete interface redesign that makes working with REDCap data feel more natural and tidyverse-friendly.
...
redcap_to_db(
  conn,
  url = "https://redcap.university.edu/api/",
...
These functions eliminate the need to remember table names or manually apply labels.

### Labeling Control

The new `collect_labeled()` function gives you control over how REDCap labels and coded values are applied:
...
You can now pull REDCap audit logs directly into your database with configurable date ranges (the default is 7 days):
...
This redesign does introduce some breaking changes---mostly parameter renames:
